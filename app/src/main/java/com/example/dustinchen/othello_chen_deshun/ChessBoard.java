...
//                            //************************** Test Information ***************************************
                            ...
                            Game.getGame().setTvBlackCount(blackCount);
                            Game.getGame().setTvWhiteCount(whiteCount);
...
//                                Game.getGame().setIvCurrentTurn(current_color);
                            ...
                            if (emptyCount == 0 || passTimes > 1) {
                                ...
                                builder.setView(Game.getGame().getLlDialog(winer));
                                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        startNewGame();
...
//        //************************** Test Information ***************************************
    ...
    private Card[][] cardsMap = new Card[10][10];
